...
public class ESGearShift : MonoBehaviour
{
    ...
    private void Reverse()
    {
        ...
        if (isreverse && vehiclecontroller.CarRb.linearVelocity.magnitude < 5f)
        {
    ...
    private void GoNeutral_Parking()
    {
        ...
        {
            vehiclecontroller.Neutral = true;
            if (vehiclecontroller.CarRb.linearVelocity.magnitude < 0.01 || vehiclecontroller.CarRb.linearVelocity.magnitude > 0.01 && vehiclecontroller.Neutral)
            {
                if (vehiclecontroller.Accel > 0)
                {
    ...
    public void NitroEngine()
    {
        if (enginemode == EngineMode.Nitro)
        {
            ...
            {
                if (NitroValue > 1 && vehiclecontroller.CarRb.linearVelocity.magnitude > 10f)
                {
                    do_nitro = true;
                }
            }
            ...
            if (vehiclecontroller.CarRb.linearVelocity.magnitude < 10f)
            {
                if (do_nitro)
                {
                    do_nitro = false;
    ...
    {
        if (vehiclecontroller.CarRb.linearVelocity.magnitude > 1f)
        {
            //print("done");
            if (vehiclecontroller.m_wheelsettings.frontwheels.frontwheelcols[0] != null)
            {
                vehiclecontroller.CarRb.AddForceAtPosition(vehiclecontroller.m_wheelsettings.frontwheels.frontwheelcols[0].transform.up * initialforce,
                    vehiclecontroller.m_wheelsettings.frontwheels.frontwheelcols[0].transform.position, ForceMode.Acceleration);
            }
            if (vehiclecontroller.m_wheelsettings.frontwheels.frontwheelcols[1] != null)
            {
                vehiclecontroller.CarRb.AddForceAtPosition(vehiclecontroller.m_wheelsettings.frontwheels.frontwheelcols[1].transform.up * initialforce,
                    vehiclecontroller.m_wheelsettings.frontwheels.frontwheelcols[1].transform.position, ForceMode.Acceleration);
            }
